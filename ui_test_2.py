...
def main():
    ...
    listbox_content = [
        ...
        blank,
        urwid.AttrWrap(
            urwid.Edit(text_edit_cap2, text_edit_text2, multiline=True),
            "editbx",
            "editfc",
        ),
        blank,
        ...
        blank,
        urwid.AttrWrap(urwid.IntEdit(text_intedit, 123), "editbx", "editfc"),
        blank,
        urwid.Padding(
            urwid.AttrWrap(urwid.Edit(text_edit_padding, ""), "editbx", "editfc"),
            left=10,
            width=50,
        ),
        blank,
        ...
        urwid.Columns(
            [
                ...
                urwid.Pile(
                    [urwid.Divider("~"), urwid.Text(text_columns2), urwid.Divider("_")]
                ),
            ],
            3,
        ),
        ...
        urwid.Columns(
            [
                ...
                ("weight", 3, urwid.AttrWrap(urwid.Text(text_weight % 3), "reverse")),
                ("weight", 4, urwid.Text(text_weight % 4)),
                ("weight", 5, urwid.AttrWrap(urwid.Text(text_weight % 5), "reverse")),
        ...
        urwid.Columns(
            [
                ("weight", 2, urwid.AttrWrap(urwid.Text(text_weight % 2), "reverse")),
        ...
        urwid.Columns(
            [
                urwid.AttrWrap(
                    urwid.Edit(text_edit_col_cap1, text_edit_col_text1, multiline=True),
                    "editbx",
                    "editfc",
                ),
                urwid.Pile(
                    [
                        urwid.AttrWrap(
                            urwid.Edit(text_edit_col_cap2, text_edit_col_text2),
                            "editbx",
                            "editfc",
                        ),
                        blank,
                        urwid.AttrWrap(
                            urwid.Edit(text_edit_col_cap3, text_edit_col_text3),
                            "editbx",
                            "editfc",
                        ),
                    ]
